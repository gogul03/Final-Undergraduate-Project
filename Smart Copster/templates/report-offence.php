  ...
  border-radius: 50%;
   ...
   <div class="content">
            <div class="container-fluid">
                <div class="row">
                <img src="assets/images/police.jpg" alt="Avatar" class="avatar">
                    <div class="col-md-8">
                        <div class="card">
                            <div class="header">
                                <h4 class="title"><b>Report an Offense</h4>
                            </div>
							<?php if(get("success")):?>
                                            <div>
...
$prefix= md5(time()*rand(1, 2)); echo strip_tags(substr($prefix ,0,6));?>" >
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
...
?>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>The Police Personnel</label>
